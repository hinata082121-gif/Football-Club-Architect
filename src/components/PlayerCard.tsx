...
export function PlayerCard({
  ...
  return (
    <article className="rounded-md border border-zinc-800 bg-zinc-950/62 p-4 backdrop-blur">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <div className="flex flex-wrap items-center gap-2">
            ...
            <h4 className="text-lg font-semibold text-zinc-50">{player.name}</h4>
          </div>
        ...
        <div className="mt-4 rounded-md border border-zinc-800 bg-zinc-900/55 p-3">
          ...
          <div className="mt-3 grid gap-2 sm:grid-cols-2">
            <button
              ...
              className="h-9 rounded-md border border-zinc-700 px-3 text-sm font-semibold text-zinc-100 transition hover:border-emerald-300 hover:text-emerald-200"
            >
